...
const STRIPE_EXPRESS_CONFIG = {stripeKey: 'undefined', accountId: '', wallets: {"enabled":false,"enableApplePay":false,"enableGooglePay":false,"enableKlarna":false}};
...
const getPrices = () => {
  return [{"name":"VIP Customer Benefits","id":26,"quantity":1,"price":0,"shippable":false,"fullPrice":0,"finalPrice":0,"productName":"VIP Customer Benefits","discountAmount":0,"discountPercentage":0},{"id":419,"name":"1x Bluelight Glasses","quantity":1,"price":0,"shippable":false,"fullPrice":39.99,"finalPrice":39.99,"productName":"1x Bluelight Glasses","discountAmount":0,"discountPercentage":0},{"id":1794,"name":"1x USB","quantity":1,"price":0,"shippable":false,"fullPrice":0,"finalPrice":0,"productName":"1x USB","discountAmount":0,"discountPercentage":0},{"id":420,"name":"2x Bluelight Glasses","quantity":1,"price":0,"shippable":false,"fullPrice":75.98,"finalPrice":75.98,"productName":"2x Bluelight Glasses","discountAmount":0,"discountPercentage":0},{"id":421,"name":"3x Bluelight Glasses","quantity":1,"price":0,"shippable":false,"fullPrice":107.97,"finalPrice":107.97,"productName":"3x Bluelight Glasses","discountAmount":0,"discountPercentage":0},{"id":422,"name":"4x Bluelight Glasses","quantity":1,"price":0,"shippable":false,"fullPrice":135.96,"finalPrice":135.96,"productName":"4x Bluelight Glasses","discountAmount":0,"discountPercentage":0},{"id":423,"name":"5x Bluelight Glasses","quantity":1,"price":0,"shippable":false,"fullPrice":159.95,"finalPrice":159.95,"productName":"5x Bluelight Glasses","discountAmount":0,"discountPercentage":0},{"id":451,"name":"Clarity Blue Glasses  Journey Package Protection","quantity":1,"price":0,"shippable":false,"fullPrice":3.5,"finalPrice":3.5,"productName":"Clarity Blue Glasses  Journey Package Protection","discountAmount":0,"discountPercentage":0},{"id":450,"name":"Clarity Blue Glasses - 3 Year Warranty","quantity":1,"price":0,"shippable":false,"fullPrice":9.95,"finalPrice":9.95,"productName":"Clarity Blue Glasses - 3 Year Warranty","discountAmount":0,"discountPercentage":0},{"id":453,"name":"Clarity Blue Glasses - Case UPGRADE!","quantity":1,"price":0,"shippable":false,"fullPrice":0,"finalPrice":0,"productName":"Clarity Blue Glasses - Case UPGRADE!","discountAmount":0,"discountPercentage":0},{"id":454,"name":"Clarity Blue Glasses - Expedited Shipping","quantity":1,"price":0,"shippable":false,"fullPrice":0,"finalPrice":0,"productName":"Clarity Blue Glasses - Expedited Shipping","discountAmount":0,"discountPercentage":0},{"id":452,"name":"Special 1x EXTRA Clarity Blue Glasses","quantity":1,"price":0,"shippable":false,"fullPrice":0,"finalPrice":0,"productName":"Special 1x EXTRA Clarity Blue Glasses","discountAmount":0,"discountPercentage":0}]
};
...
async function createOrderViaWallet(confirmationToken, paymentMethodId) {
  ...
  const orderData = {
    pageId: "x2kbJ82v-s_RzvqOZkvB36PghkP-OCvbme399NPWJ3v-_NpDXGXInEo3Pr0daB_s",
    action: "process",
...
const getStates = async (countryIso2Code) => {
  ...
  try {
    if (!countriesStatesCache) {
      const res = await fetch('/698b6388cc4a6494db4e561e-preview/scripts/countriesData/countriesStates.json', { cache: 'no-store' });
...
if (typeof validateAndSendToKlaviyo === "function") {
  try {
    ...
    var pageReadyPayload = {
      ...
      data: { pageName: "CBG-Checkout-v1", pageType: "Checkout" },
    };
